                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control form-control-sm" value="{{ $user->name ?? old('name') }}">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control form-control-sm" value="{{ $user->email ?? old('email') }}">
                                    @error('email')
                                        <small class="text-danger">
                                            {{ $message }}
                                        </small>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password">Password <small>(tidak wajib diisi jika tidak ingin mengganti password)</small></label>
                                ...
                                <div class="form-group">
                                    <label for="password_confirmation">Konfirmasi Password <small>tidak (wajib diisi jika tidak ingin mengganti password)</small></label>
