...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">Data Gambar {{ $budaya->name }}</div>

                <div class="card-body table-responsive">
                    <form action="{{ route('budaya.upload', $budaya->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                        <div class="row my-3">
                            <div class="col-md-5">
                    ...
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('budaya.deleteImage', $data->id) }}" method="post">
                                        @csrf
                                        @method('DELETE')
